...
- [OpenBIOS](https://pcsx-redux.consoledev.net/openbios/) (MIT) is packed by
  default from the checksummed `openbios/openbios.bin` in this tree
- Official BIOS dumps can be used at runtime (`WITH_BIOS_PATH`) or packed at
  build time (`WITH_EMBEDDED_BIOS_PATH`; pass empty to skip packing)
